	...
	<div class="container margin-bottom-15">
		<div class="row">
			<div class="col-md-6 col-sm-6 info-text-hi">
				<h4 class="blue-color">Hai {{ title_case(auth()->user()->karyawan->NamaKaryawan) }}</h4>
				...
				<div class="panel panel-default panel-waiting panel-box">
					...
					<div class="panel-footer">
						<div class="row margin-bottom-15">
							<div class="col-sm-6">
								<div class="footer-1">
									{{ $data['pendingRegisteredCount'] }} Dokumen Registered
								</div>
							</div>
							<div class="col-sm-6 text-right footer-2">
								<a href="{{ route('backends.kpi.rencana.individu.bawahanlangsung') }}" class="btn btn-default btn-yellow">Lihat Detail</a>
							</div>
						</div>
						<div class="row margin-bottom-15">
							<div class="col-sm-6">
								<div class="footer-1">
									{{ $data['pendingConfirmedCount'] }} Dokumen Confirmed
								</div>
							</div>
							<div class="col-sm-6 text-right footer-2">
								<a href="{{ route('backends.kpi.rencana.individu.bawahantaklangsung') }}" class="btn btn-default btn-yellow">Lihat Detail</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-sm-3 col-xs-6">
				    	<div class="item-listing">
			    			<a href="{{ route('dashboard.infokpi.detail', $item->ID) }}">
								<img src="{{ route('image.resize', ['modulename' => 'info', 'width' => 960, 'height' => 637, 'imagename' => (! is_null($item->Gambar)) ? $item->Gambar : 'dummy.png']) }}" class="responsive-image">

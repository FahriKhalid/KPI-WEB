        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-default panel-faq item-faq-main">
                <div class="panel-body">
                    <h4 class="item-title-faq text-center">Buat FAQ</h4>
                        <form class="form-horizontal" id="formId" method="post" action="{{route('faq.store')}}">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Pertanyaan</label>
                                <div class="col-sm-5">
                                    <input type="text" name="Question"  class="form-control" placeholder="Pertanyaan" value="{{old('Question')}}" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Jawaban</label>
                                <div class="col-sm-7">
                                    <textarea rows="10" name="Answer">{!! old('Answer') !!}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-7 save-container">
                                    <button type="submit" onclick="" id="save" class="btn btn-default btn-blue">Kirim</button>

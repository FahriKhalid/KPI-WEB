    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 margin-top-15">
                <ul class="kpi-menu">
                    <li>
                        <a href="{{ route('backends.kpi.realisasi.individu.detailbawahantaklangsung', ['id' => $data['headerrealisasi']->ID]) }}">Realisasi KPI</a>
                    </li>
                    <li class="active">
                        <a href="{{ route('backends.kpi.realisasi.individu.documentbawahantaklangsung', ['id' => $data['headerrealisasi']->ID]) }}">Dokumen</a>
                    </li>
                </ul>
            </div>
        </div>

...
@section('content')
    <form class="form-horizontal" action="{{ route('backends.kpi.realisasi.unitkerja.store') }}" method="post">
        {!! csrf_field() !!}
        <div class="container">
            <div class="row">
                            ...
                            <div class="col-sm-11 col-sm-offset-1">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="hidden" name="IsUnitKerja" value="1">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Periode</label>
                                    <div class="col-sm-3">
                                        <select name="IDJenisPeriode" class="form-control">
                                            @foreach($data['periode'] as $periode)
                                                <option value="{{ $periode->ID }}">{{ $periode->KodePeriode }} - {{ $periode->NamaPeriodeKPI }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="text-right save-container">
                        ...
                        <a href="{{ route('backends.kpi.realisasi.unitkerja') }}" class="btn btn-default btn-orange">Batal</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            return options = {
                ...
                template: {
                    ...
                    method: function(value, item) {
                        return value + ' - ' + item.NamaKaryawan + ' (' + item.organization.position.PositionTitle + ')';
                    }
                },
                list: {

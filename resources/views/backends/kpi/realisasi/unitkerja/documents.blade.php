    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 margin-top-15">
                <ul class="kpi-menu">
                    <li>
                        <a href="{{ route('backends.kpi.realisasi.unitkerja.editdetail', ['id' => $data['headerrealisasi']->ID]) }}">Realisasi KPI</a>
                    </li>
                    <li class="active">
                        <a href="{{ route('backends.kpi.realisasi.unitkerja.document', ['id' => $data['headerrealisasi']->ID]) }}">Dokumen</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="panel panel-default panel-box panel-create">
                    <div class="panel-body">
                        ...
                        <div class="col-sm-11 col-sm-offset-1 margin-bottom-15">
                            <form class="form-horizontal" method="post" action="{{ route('backends.kpi.realisasi.unitkerja.storeDocument', ['id' => $data['headerrealisasi']->ID]) }}" enctype="multipart/form-data">
                                {!! csrf_field() !!}
                            ...
                            <table id="dokumenkpi-table" class="table table-striped" width="100%">
                                ...
                                @forelse($data['headerrealisasi']->attachments as $attachment)
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="{{ route('backends.kpi.realisasi.unitkerja.documentdownload', ['id' => $data['headerrealisasi']->ID, 'attachmentID' => $attachment->ID]) }}" class="btn btn-info btn-sm"><i class="fa fa-download"></i> Unduh</a> </td>
                                    </tr>
                                @empty
                                    <tr>
...
@section('customjs')
    <script type="text/javascript">
        ...
        $('#deleteAttachmentRealisasi').click(function() {
            ...
            var action = "{{ route('backends.kpi.realisasi.unitkerja.deletedocument') }}";

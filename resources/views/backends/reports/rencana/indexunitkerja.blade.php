        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                ...
                <div class="panel panel-default panel-box">
                    <div class="col-sm-12">
                        <div class="panel-title-box">Laporan Rencana KPI Individu Per Unit Kerja Periode <span class="badge bg-info">{{ $data['periode'] }}</span></div>
                    </div>
                    <div class="filter-kpi">
                        <div class="col-sm-12">
                            <div class="row">
                                <form action="{{ route('report.rencana.kpiunitkerja.index') }}" method="get">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-1">
                                        <a class="btn btn-yellow" href="{{ route('report.rencana.kpiunitkerja.index') }}">Reset</a>
                                    </div>
                    ...
                    <div class="panel-body">
                        <div class="margin-min-15" style="overflow-x: scroll; width: calc(100% + 30px);">
                            <table id="reportrencanaunitkerja-table" class="table table-striped">
                                <thead>
                                <tr>
                                    <th>No.</th>
                                    <th>Unit Kerja</th>
...
@section('customjs')
    <script>
        $('#reportrencanaunitkerja-table').DataTable({

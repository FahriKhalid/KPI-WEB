			...
			<div class="col-md-12 col-sm-12">
				...
				<div class="panel panel-default panel-box">
					<div class="panel-body">
						<div class="col-sm-12">
							<div class="panel-title-box">Data User</div>
						</div>
						<div class="col-sm-9">
							<div class="custom-button-container">
								<a href="{{ route('backend.master.user.create') }}">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					Peringatan! Data yang dihapus tidak akan bisa dikembalikan dan User yang dihapus tidak akan bisa login kembali.
				</div>
	...
	<script>
        $(function() {
            $('#user-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route("backend.master.user") !!}',
                columns: [
                    { data: 'username', name: 'username' },
                    { data: 'NPK', name: 'Users.NPK'},
                    { data: 'karyawan.NamaKaryawan', name: 'karyawan.NamaKaryawan' },
                    { data: 'LdapActive', name: 'LdapActive', searchable: false, sortable: false },
